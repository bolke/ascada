...
#define PROJECTDEFINES_H  
  ...
  #define VDATE                         "Apr 03 2018"                                   //build date, used as version, format "MMM DD YYYY"
  #define VTIME                         "12:14:23"                                      //build time, used as version, format "hh:mm:ss"

  #define PROJECT_ID                    "xx"                                            //unique project identifier, format base64 "xx"
  ...
  #define ALARM_BIT_CNT                 (ALARM_WORD_CNT*16)                             //total number of alarms
  ...
  #define GPIO_INPUT                    GPIO_INPUT_LOW                                  //value for gpio input default  
